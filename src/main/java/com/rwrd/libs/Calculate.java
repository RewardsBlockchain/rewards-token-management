...
public class Calculate {
	...
	/**
	 * Calculate the contract address before release
	 */
	private static String calculateContractAddress(String address, long nonce) {
		//Sample https://ropsten.etherscan.io/tx/0x728a95b02beec3de9fb09ede00ca8ca6939bad2ad26c702a8392074dc04844c7
	...
	/**
	 * Calculate transaction hash before submitting
	 */
	private static String caculateTransactionHash(String signedData) {
		//Sample https://ropsten.etherscan.io/tx/0xfd8acd10d72127f29f0a01d8bcaf0165665b5598781fe01ca4bceaa6ab9f2cb0
